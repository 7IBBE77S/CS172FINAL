...
void Warrior::initializeWarrior(const std::string name, playerType subclass)
{
	...
	this->inventory.addItem(Weapon(1, 5, "Great Sword", 1, 1, 1, 0));

	this->inventory.addItem(Gear(1, 1, "Horned Helmet", 1, 1, 1, 0));
	this->inventory.addItem(Gear(1, 1, "Battle worn Vest", 1, 1, 1, 0));
	this->inventory.addItem(Gear(1, 1, "Iron Gauntlet", 1, 1, 1, 0));
	this->inventory.addItem(Gear(1, 1, "Iron Greaves", 1, 1, 1, 0));
this->weapon = Weapon(1, 5, "Great Sword", 1, 1, 1, 0);
	...
	this->gauntlet = Gear(1, 1, "Iron Gauntlet", 1, 1, 1, 0);
